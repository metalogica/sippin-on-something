...
document.addEventListener('alpine:init', () => {
  Alpine.store('quiz', {
    ...
    _resolvePersonalityType(score) {
      if (score > PERSONALITY_TYPE_SCORE_MAP[PERSONALITY_TYPE.SOPHISTICATED_SIPPER]) {
        return PERSONALITY_TYPE.SOPHISTICATED_SIPPER;
      } else if (score > PERSONALITY_TYPE_SCORE_MAP[PERSONALITY_TYPE.ADVENTUROUS_SIPPER]) {
        return PERSONALITY_TYPE.ADVENTUROUS_SIPPER;
      } else if (score > PERSONALITY_TYPE_SCORE_MAP[PERSONALITY_TYPE.SOCIAL_SIPPER]) {
